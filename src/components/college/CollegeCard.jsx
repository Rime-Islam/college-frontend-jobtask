...
const CollegeCard = ({ college }) => {
  ...
  const formatAdmissionDates = () => {
    ...
    const startDate = new Date(college.admissionDates.startDate).toLocaleDateString('en-US', { 
      month: 'short', 
      day: 'numeric' 
    });
    const endDate = new Date(college.admissionDates.endDate).toLocaleDateString('en-US', { 
      month: 'short', 
      day: 'numeric',
      year: 'numeric'
    });
    ...
    <div className="bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl">
      ...
      <div className="p-5">
        ...
        <div className="mt-2 flex items-center text-gray-600">
          ...
          <span className="text-sm">{college.location?.city}, {college.location?.country}</span>
        </div>
